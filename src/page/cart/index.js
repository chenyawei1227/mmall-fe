/*
 * @Author: chenyawei 
 * @Date: 2020-04-20 00:03:00 
 * @Last Modified by: chenyawei
 * @Last Modified time: 2020-04-20 21:13:53
 */
...
var page = {
    ...
    // 数据匹配, !!!!data.cartProductVoList.length 强制转换
    filter : function(data){
        data.notEmpty = !!data.cartProductVoList.length;//强制转换为布尔型
    },
    // 显示错误信息
